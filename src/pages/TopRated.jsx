...
import { fetchTopRatedMoviesData, resetTopRatedMovies} from "../store/topRatedSlice";
...
const TopRated = () => {
  ...
  useEffect(() => {
    dispatch(resetTopRatedMovies());
    dispatch(fetchTopRatedMoviesData(1));
  }, [dispatch]);
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (
        ...
        dispatch(fetchTopRatedMoviesData(page));
      }
    };
  ...
  return (
    <div className="container py-4">
      <h2 className="text-light text-center mb-3">Top Rated Movies</h2>
